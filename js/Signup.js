...
// console.log(API_KEY)
  ...
  const db = getDatabase()
    ...
    let preview = document.querySelector('.Cove');
    let preview2 = document.querySelector('.left');
    ...
    function validation(){
        ...
        let email = /^[a-z0-9]+@(gmail|yahoo|outlook)\.com$/;
...
//--------------------------------------ENCRIPTTION---------------------------------------------------//
      ...
      function encPass(){
            let passwordEnc = CryptoJS.AES.encrypt(password1.value, password1.value)
